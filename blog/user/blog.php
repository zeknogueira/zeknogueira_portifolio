                    ...
                    if (isset ($_GET['articles_categories'])) {
                        ...
                        if ($result->num_rows > 0) {
                            while ($article_content = $result->fetch_assoc()) {
                                ...
                                <a href="../user/article.php?article_id=<?php echo $iarticle_content["article_id"] ?>"
                                    cursor="pointer">
                        ...
                        if ($query_sql_select_articles->num_rows > 0) {
                            while ($info_articles = $query_sql_select_articles->fetch_assoc()) {
                                ...
                                ?>
                                <a href="../user/article.php?article_id=<?php echo $info_articles["article_id"] ?>"
                                    cursor="pointer">
                                    <article class="principal_articles" id="article">
                                        <div class="principal_articles_tittle_date_box">
                                            <h2 class="principal_articles_tittle">
                        ...
                        <div class="side_articles_box">
                            ...
                            if ($query_result->num_rows > 0) {
                                while ($info_recent_articles = $query_result->fetch_assoc()) { ?>
                                    <a href="../user/article.php?article_id=<?php echo $info_recent_articles["article_id"] ?>"
                                        cursor="pointer">
                    ...
                    <div class="side_articles_box_box">
                        <div class="side_articles_box">
                            <nav class="articles_categories_nav">
                                <div>
                                    <a href="../user/blog.php?articles_categories=programação">Programação</a>
                                    <hr class="articles_line_division">
                                </div>
                                <div>
                                    <a href="../user/blog.php?articles_categories=música">Música</a>

                                    <hr class="articles_line_division">
                                </div>
                                <div>
                                    <a href="../user/blog.php?articles_categories=marketing">Marketing</a>
                                    <hr class="articles_line_division">
                                </div>
                            </nav>
                        </div>
